...
const String onBoardViewOneBodyOne = "Join Namma \nChennai music and \nenjoy the chennai sounds";
...
class OnBoardPage extends StatelessWidget{
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              pageIndicator(deviceWidth,controller.page.value == 1),
                              pageIndicator(deviceWidth,controller.page.value == 2),
                              pageIndicator(deviceWidth,controller.page.value == 3),
                            ],),
                        ),
                        if(controller.page.value == 1)...{
                          OnBoardView(onBoardViewOneBodyOne,onBoardViewOneBodyTwo,"chennai_image_5.png")
                        }else if(controller.page.value == 2)...{
                          OnBoardView(onBoardViewTwoBodyOne,onBoardViewTwoBodyTwo,"chennai_image_6.png")
                        }else if(controller.page.value == 3)...{
                          OnBoardView(onBoardViewThreeBodyOne,onBoardViewThreeBodyTwo,"chennai_image_7.png")
                        }
                      ],
                    ),
            ),
  ...
  Widget pageIndicator(double deviceWidth,bool currentPage){
    return Container(height: 4,width: deviceWidth/5, decoration:  BoxDecoration(color: currentPage == true ? Color(0xffe4e4f0): Color(0x3de4e4f0) ,borderRadius: BorderRadius.all(Radius.circular(20))));
  }
}
      ...
      children: [
        Padding(
         ...
         child: Column(
           ...
           crossAxisAlignment: CrossAxisAlignment.start,
           children: [
           Text(body1, style: const TextStyle(color: Colors.white, fontSize: 35, fontWeight: FontWeight.bold),),
             const SizedBox(height: 20),
             Text(body2, style: const TextStyle(color: Colors.grey, fontSize: 18, fontWeight: FontWeight.bold),),
         ],
         ),
       ),
        SizedBox(height: 30),
